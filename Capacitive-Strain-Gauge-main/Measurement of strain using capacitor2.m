...
% Case Study: Mechatronic System Simulation using MATLAB
 
% Topic: Capacitive Strain Gauges
 
% Group number: 16a
 
% Guided By: Prof.Dr. Dmitry Rychkov
 
% Prepared by: Haider Matin (22102111)
%              Murtuza Godil (22103452)
%              Savan Ghelani (22101599)
%              Safeer Muhammad (22103086)       
...
% % Fixed plate indication arrow
% 
% xx = [.3,.35];
% yy = [.3,.38];
% a = annotation('textarrow',xx,,'String','Fixed plate ');
% a.Color = 'black';
% a.FontSize = 14;
